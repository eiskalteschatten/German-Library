...
#import "PonsViewController.h"

@interface PonsViewController ()

@end

@implementation PonsViewController
...
- (void)webView:(WebView *)sender didFinishLoadForFrame:(WebFrame *)frame {
    ...
    [_webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"window.pageYOffset=0;"]];
